    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li1, file, 13, 1, 260);
    			add_location(li2, file, 14, 1, 305);
    			add_location(li3, file, 15, 1, 407);
    			add_location(ol, file, 11, 0, 183);
    			add_location(h2, file, 18, 0, 506);
    			add_location(input, file, 21, 1, 530);
    			add_location(div, file, 20, 0, 523);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
